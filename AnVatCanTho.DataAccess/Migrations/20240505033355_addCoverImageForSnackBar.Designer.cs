...
namespace AnVatCanTho.DataAccess.Migrations
{
    ...
    [Migration("20240505033355_addCoverImageForSnackBar")]
    partial class addCoverImageForSnackBar
    {
            ...
            modelBuilder.Entity("AnVatCanTho.Models.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "NA",
                            DisplayName = "Admin",
                            Dob = new DateTime(2024, 5, 5, 10, 33, 53, 554, DateTimeKind.Local).AddTicks(2687),
                            Email = "admin@site.com",
                            Password = "$2a$11$i5FTGp16NNRSeoxRXX0PtOekr7hmlR6sUkTNrxAYlByBYGbxPTq3u",
                            RoleId = 1,
                            Tel = "NA",
                            Username = "admin"
                        });
            ...
            modelBuilder.Entity("AnVatCanTho.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Avatar = "user1.jpg",
                            DisplayName = "NVA",
                            Dob = new DateTime(2024, 5, 5, 10, 33, 53, 404, DateTimeKind.Local).AddTicks(9116),
                            Email = "nva@gmail.com",
                            Password = "$2a$11$BYzzc5mb5GJJaUyBJ0hUfOW1xtvdiIHPM1n.qmJhdNfEWZ36o9p1G",
                            Tel = "0123456789",
                        ...
                        new
                        {
                            ...
                            Avatar = "user2.jpg",
                            DisplayName = "NVB",
                            Dob = new DateTime(2024, 5, 5, 10, 33, 53, 554, DateTimeKind.Local).AddTicks(2228),
                            Email = "nvb@gmail.com",
                            Password = "$2a$11$oDTUTE2FWLZCnkHGoxEXueZylq0W0HpowZd8GLSeSCPV5ZsSzk.Xa",
                            Tel = "0223456789",
            ...
            modelBuilder.Entity("AnVatCanTho.Models.SnackBar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Dob = new DateTime(2024, 5, 5, 10, 33, 53, 840, DateTimeKind.Local).AddTicks(9115),
                            Email = "snackbar1@site.com",
                            Password = "$2a$11$Ggy2rLjWnD0PJ2MjcLlqE.uxk2TEzWO3pklRj6zGJXpQIb2Okg9IK",
                            Tel = "0312345678",
                            Username = "snackbar1"
                        },
                        new
                        {
                            ...
                            Dob = new DateTime(2024, 5, 5, 10, 33, 53, 991, DateTimeKind.Local).AddTicks(8937),
                            Email = "snackbar2@site.com",
                            Password = "$2a$11$zsq1ji45xLR8lFqXKPIgJ.TVDTADP7qlEsFHgOvzrLtIrKYrd6stS",
                            Tel = "0312345678",
                            Username = "snackbar2"
                        },
                        new
                        {
                            ...
                            Dob = new DateTime(2024, 5, 5, 10, 33, 54, 186, DateTimeKind.Local).AddTicks(4434),
                            Email = "snackbar3@site.com",
                            Password = "$2a$11$.4EOlLrJ4M0lp/VgAjM8wO9upZQoPMWzHV0cctnGF4erKe5.r/sMC",
                            Tel = "0312345678",
                            Username = "snackbar3"
                        },
                        new
                        {
                            ...
                            Dob = new DateTime(2024, 5, 5, 10, 33, 54, 329, DateTimeKind.Local).AddTicks(3840),
                            Email = "snackbar4@site.com",
                            Password = "$2a$11$O0deYTPm/MjiwoCGfpJe5OEgZ86wtkifhBQDPgD/pBl6iyBG/HrFu",
                            Tel = "0312345678",
                            Username = "snackbar4"
                        },
                        new
                        {
                            ...
                            Dob = new DateTime(2024, 5, 5, 10, 33, 54, 470, DateTimeKind.Local).AddTicks(4222),
                            Email = "snackbar5@site.com",
                            Password = "$2a$11$rMDgHRrC1qenzUlXnFHqN.mgTy4j.frfhS2YaQINZR/do8o1EwLxa",
                            Tel = "0312345678",
                            Username = "snackbar5"
                        });
                });
